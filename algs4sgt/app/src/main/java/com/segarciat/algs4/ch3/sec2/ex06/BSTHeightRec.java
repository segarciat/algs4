 ...
 * Extended for this exercise to provide a recursive implementation
 * of {@link BSTHeightRec#height()}, which gives the height of the tree.
 * @author Sergio E. Garcia Tapia
 */
public final class BSTHeightRec<Key extends Comparable<Key>, Value>{
