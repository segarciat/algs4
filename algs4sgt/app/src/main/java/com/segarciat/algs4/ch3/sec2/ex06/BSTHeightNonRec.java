package com.segarciat.algs4.ch3.sec2.ex06;
...
/**
 * <strong>3.2.6)</strong>
 * Implementation of a binary search tree, as given in Section 3.2
 * of "Algorithms" by Sedgewick and Wayne (Algorithm 3.3).
 * Extended for this exercise to provide a non-recursive implementation
 * of {@link BSTHeightNonRec#height()}, which gives the height of the tree.
 * @author Sergio E. Garcia Tapia
 */
public final class BSTHeightNonRec<Key extends Comparable<Key>, Value>{
    ...
    private static class Node<Key, Value> {
        ...
        private Node(Key key, Value value, int n, int h) {
            this.key = key;
            this.value = value;
            this.n = n;
            this.h = h;
    ...
    private int resetHeight(Node<Key, Value> node) {
