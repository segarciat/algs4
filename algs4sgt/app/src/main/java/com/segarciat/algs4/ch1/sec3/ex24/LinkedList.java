package com.segarciat.algs4.ch1.sec3.ex24;

import edu.princeton.cs.algs4.StdOut;

/**
 * <strong>1.3.24)</strong>
 * Write a method <code>removeAfter()</code> that takes a linked-list
 * <code>Node</code> as argument and removes the node following the
 * given one (and does nothing if the argument or the next field in the
