package com.segarciat.algs4.ch2.sec4.ex34;
 ...
 * Implements the index (minimum-oriented) priority-queue abstract data type specified
 * in Section 2.4.
...
public class IndexMinPQ<Key extends Comparable<Key>> {
    ...
    public void delete(int i) {
        ...
        // the leaf we swapped with may have been in a totally different subtree
        // therefore we cannot guarantee that, say, a sink() is enough
        swim(j);
        sink(j);
    }
    ...
    public static void main(String[] args) {
        ...
        pq.delete(0);
        System.out.println("contains index 0? " + pq.contains(0));

        System.out.println("changing index 1 to negative number");
        pq.changeKey(1, -100);

        System.out.printf("min is %d at index %d%n", pq.minKey(), pq.minIndex());
