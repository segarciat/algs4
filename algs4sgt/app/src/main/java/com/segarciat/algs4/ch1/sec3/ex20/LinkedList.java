package com.segarciat.algs4.ch1.sec3.ex20;

import edu.princeton.cs.algs4.StdOut;

/**
 * <strong>1.3.20)</strong>
 * Write a method <code>delete()</code> that takes an <code>int</code> argument
 * <code>k</code> and deletes the <code>k</code>th element in a linked list, if
 * it exists.
 * <p>
