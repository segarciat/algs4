 ...
 * it uses my implementation of {@link RemoveVertex} as opposed to
...
public final class TestSearch {
    public static void main(String[] args) {
        ...
        RemoveVertex search = new RemoveVertex(G, s);
        ...
        StdOut.printf("Vertex %d can be removed from the connected component.%n", search.removedVertex());
