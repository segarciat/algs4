package com.segarciat.algs4.ch3.sec1.ex28;
...
/**
 * <strong>3.1.28)</strong>
 * Builds on Exercise 3.1.25) by making inserts of keys that
 * are larger than every other key in the table take constant
 * time (amortized, since this implementation uses array resizing).
