package com.segarciat.algs4.ch2.sec4.ex27;
...
/**
 * <strong>2.4.27)</strong>
 * Implements a <code>MaxPQ</code> as in section 2.4 of Algorithms
 * by Sedgewick and Wayne, with a method {@link MaxPQ#min()}.
 * @param <Key>
...
public class MaxPQ<Key extends Comparable<Key>> implements IMaxPQ<Key> {
    ...
    /**
     * A minimum item in the priority queue.
     */
    ...
    public void insert(Key key) {
        ...
        pq[++n] = key;
        swim(n);
        if (minKey == null || SortUtil.less(key, minKey))
            minKey = key;
    }
