...
mystery(43046721, 0) -> 1
	...
	\end{ex}
	\begin{sol}
		See the \texttt{com.segarciat.algs4e.\_21.StdinDivision} class. Notice
	...
	\end{ex}
	\begin{sol}
		See the \texttt{com.segarciat.algs4e.\_22.BinarySearchTrace} class. Since the
